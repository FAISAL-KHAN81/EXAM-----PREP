...
const Examinee = () => {
  ...
  const handlefetch = async () => {
    try {
      ...
      console.error("Error fetching examinees and sessions:", err);
    }
  };
            ...
            <form className="border p-2 rounded" onSubmit={handleSubmit}>
              ...
              <div className="row mb-2">
                ...
                <div className="col-sm-3">
                  ...
                  <input className="form-control" name="course" value={form.course} onChange={handleChange} placeholder="Course (e.g. B.Tech)" required />
                </div>
                <div className="col-sm-3">
                  <label className="form-label fw-bold">Branch</label>
                  <input className="form-control" name="branch" value={form.branch} onChange={handleChange} placeholder="Branch (e.g. CSE)" required />
                </div>
                <div className="col-sm-3">
                  <label className="form-label fw-bold">Session</label>
                  <select name="session" value={form.session} onChange={handleChange} className="form-select" required>
              ...
              <button type="button" className="btn btn-secondary mb-1" onClick={() => setEditFormVisible(false)}>Cancel</button>
            </form>
          </div>
        </div>
      )}
