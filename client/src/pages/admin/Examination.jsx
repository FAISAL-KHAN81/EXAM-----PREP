...
const Examination = () => {
  ...
  const fetchData = async () => {
    try {
      const [subjectRes, sessionRes, examRes] = await Promise.all([   //promise.all -> fetch multiple apis at once
  ...
  const handleEdit = (exam) => {
    setFormData({
      ...
      questionDistribution: exam.questionDistribution ? exam.questionDistribution.map(d => ({
        subject: d.subject?._id || d.subject || '',
        numberOfQuestions: d.questionCount || ''
